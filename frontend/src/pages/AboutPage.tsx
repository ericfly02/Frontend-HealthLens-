      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-white bg-opacity-80 backdrop-blur-md rounded-xl shadow-lg p-8">
          ...
          <section className="mb-12">
            ...
            <p className="text-indigo-600 leading-relaxed">
              SkinAI leverages cutting-edge artificial intelligence to analyze skin and eye conditions through user-uploaded images. Our pretrained Convolutional Neural Network (CNN) quickly assesses the uploaded photos and provides users with potential diagnoses, enabling them to understand their health concerns better. This initial analysis serves as a stepping stone for users to seek further medical advice if needed.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-indigo-700 mb-4">Why SkinAI?</h2>
            <p className="text-indigo-600 leading-relaxed mb-4">
              Many people in developing countries face significant barriers to accessing healthcare, including a lack of medical professionals, long travel distances, and financial constraints. SkinAI addresses these challenges by offering:
            </p>
          ...
          <section>
            ...
            <p className="text-indigo-600 leading-relaxed">
              We invite you to explore our platform and discover how SkinAI can help you understand your health better. Together, we can create a healthier future for everyone. If you have any questions or feedback, please don't hesitate to reach out!
            </p>
          </section>
        </div>
      </main>
